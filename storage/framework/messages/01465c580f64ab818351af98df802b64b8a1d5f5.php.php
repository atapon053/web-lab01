<?php $__env->startSection('header'); ?>
	<section class="content-header">
	  <h1>
	    <span class="text-capitalize"><?php echo e(_i($crud->entity_name_plural)); ?></span>
	    <small><?php echo e(_i('All')); ?> <span><?php echo e(_i($crud->entity_name_plural)); ?></span> <?php echo e(_i('in data base')); ?>.</small>
	  </h1>
	  <ol class="breadcrumb">
